...
public class RegisterJFrame extends javax.swing.JFrame {
    ...
    public void submitDataToDB() {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO resgister (userName, password) VALUES (?,?)");

            ps.setString(1, userName);
            if (hashMd5(password).equals("")) {
                JOptionPane.showMessageDialog(null, "Ma hoa that bai!");
                return;
            }
